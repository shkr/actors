...
---
  * Ledger Example
   ...
   * The persistence plugin is configured to use [Cassandra](https://github.com/krasserm/akka-persistence-cassandra). The LevelDB and Local FileSystem which is available as part of akka-persistence can also be used. In order to do that
     [Configuration](https://github.com/shkr/actors/blob/master/src/main/scala/org/shkr/actors/persistence/Configuration.scala#L18) has to be modified.
```
